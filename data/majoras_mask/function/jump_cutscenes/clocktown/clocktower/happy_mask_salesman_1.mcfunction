...
execute unless entity @s[scores={click=0..}] run tp @s 9 95 -57 157 15
execute unless entity @s[scores={click=0..}] run fill 8 96 -57 8 96 -57 minecraft:barrier
execute unless entity @s[scores={click=0..}] run fill 10 96 -57 10 96 -57 minecraft:barrier
execute unless entity @s[scores={click=0..}] run fill 9 96 -58 9 96 -58 minecraft:barrier
execute unless entity @s[scores={click=0..}] run fill 9 96 -56 9 96 -56 minecraft:barrier
execute unless entity @s[scores={click=0..}] run fill 9 98 -57 9 98 -57 minecraft:barrier
...
execute if entity @s[scores={click=1}] run summon armor_stand 6 93 -64 {Tags:[HappyMaskSalesman],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,DisabledSlots:16191,ShowArms:1b,Rotation:[340f],ArmorItems:[{id:"leather_boots",Count:1b,tag:{display:{color:9502975}}},{id:"leather_leggings",Count:1b,tag:{display:{color:9502975}}},{id:"leather_chestplate",Count:1b,tag:{display:{color:9502975}}},{id:"player_head",Count:1b,tag:{SkullOwner:{Id:[I;-939075392,516310777,-2017100543,-719750971],Properties:{textures:[{Value:"eyJ0ZXh0dXJlcyI6eyJTS0lOIjp7InVybCI6Imh0dHA6Ly90ZXh0dXJlcy5taW5lY3JhZnQubmV0L3RleHR1cmUvYjY4YjQwNzJjZWVjOWQ1ZDc3YzI4ZWZhYjQ5NGZmZjg3ZjU0ZGM0NDQ0ZjM5YmQzMzNiMzgyMmQ1ODAyMzg1YSJ9fX0="}]}}}}],HandItems:[{id:"minecraft:stone",tag:{CustomModelData:1},Count:1b},{id:"minecraft:stone",tag:{CustomModelData:1},Count:1b}],CustomName:'{"text":"HappyMaskSalesman"}',Pose:{Body:[10f,0f,0f],LeftArm:[328f,0f,37f],RightArm:[335f,0f,322f]}}
execute if entity @s[scores={click=1}] run summon armor_stand 6 93 -64 {Tags:[HappyMaskSalesmanBack],Invisible:1b,Invulnerable:1b,NoBasePlate:1b,NoGravity:1b,DisabledSlots:16191,Rotation:[340f],ArmorItems:[{},{},{},{id:"minecraft:acacia_planks",Count:1b,tag:{CustomModelData:2}}],CustomName:'{"text":"HappyMaskSalesmanBack"}',Pose:{Body:[10f,0f,0f],Head:[10f,0f,0f],LeftArm:[328f,0f,37f],RightArm:[335f,0f,322f]}}
...
execute if entity @s[scores={click=3}] run fill 8 96 -57 8 96 -57 minecraft:air
execute if entity @s[scores={click=3}] run fill 10 96 -57 10 96 -57 minecraft:air
execute if entity @s[scores={click=3}] run fill 9 96 -58 9 96 -58 minecraft:air
execute if entity @s[scores={click=3}] run fill 9 96 -56 9 96 -56 minecraft:air
execute if entity @s[scores={click=3}] run fill 9 98 -57 9 98 -57 minecraft:air

execute if entity @s[scores={click=3}] run tp @s 7 93 -62 153 0
execute if entity @s[scores={click=3}] run fill 6 94 -62 6 94 -62 minecraft:barrier
execute if entity @s[scores={click=3}] run fill 8 93 -62 8 93 -62 minecraft:barrier
execute if entity @s[scores={click=3}] run fill 8 95 -62 8 95 -62 minecraft:barrier
execute if entity @s[scores={click=3}] run fill 7 94 -63 7 94 -63 minecraft:barrier
execute if entity @s[scores={click=3}] run fill 7 94 -61 7 94 -61 minecraft:barrier
execute if entity @s[scores={click=3}] run fill 7 95 -62 7 95 -62 minecraft:barrier
