# East Gate
execute if entity @s[x=76,y=107,z=3,dx=0,dy=7,dz=5] run function majoras_mask:teleports/clocktown/east_clocktown/east_gate/inside

# Honey & Darling Shop
execute if entity @s[x=53,y=104,z=23,dx=0,dy=3,dz=2] run function majoras_mask:teleports/clocktown/east_clocktown/honey_darling_shop/inside
execute if entity @s[x=59,y=81,z=24,dx=0,dy=3,dz=2] run function majoras_mask:teleports/clocktown/east_clocktown/honey_darling_shop/outside
...
execute if entity @s[x=44,y=84,z=-25,dx=0,dy=2,dz=0.5] run function majoras_mask:teleports/clocktown/east_clocktown/mayors_residence/outside

# Milk Bar
execute if entity @s[x=42,y=104,z=1,dx=2,dy=3,dz=0] run function majoras_mask:teleports/clocktown/east_clocktown/milk_bar/inside
execute if entity @s[x=0,y=82,z=13,dx=2,dy=3,dz=0] run function majoras_mask:teleports/clocktown/east_clocktown/milk_bar/outside

# Shooting Gallery
execute if entity @s[x=44,y=104,z=40,dx=0,dy=3,dz=0] run function majoras_mask:teleports/clocktown/east_clocktown/shooting_gallery/inside
execute if entity @s[x=54,y=71,z=45,dx=2,dy=3,dz=0] run function majoras_mask:teleports/clocktown/east_clocktown/shooting_gallery/outside
...
execute if entity @s[x=30,y=68,z=25,dx=2,dy=3,dz=0] run function majoras_mask:teleports/clocktown/east_clocktown/treasure_chest_shop/outside
