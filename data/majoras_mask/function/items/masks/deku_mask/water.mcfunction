...
execute if score @s WorkingVariable matches 1 run tellraw @s "You're almost wet"
$execute unless entity @e[tag=$(id)] as @s at @s rotated ~ 0 run summon happy_ghast ^ ^-4.1 ^ {NoAI: 1b, Invulnerable:1b, Tags:["$(id)"]}
