...
scoreboard objectives add DekuFlowerPeakHeight dummy
scoreboard objectives add DekuFlowerGoldPeakHeight dummy
...
scoreboard objectives add ExpectedFlowerPosition dummy
scoreboard objectives add FlowerDescentSpeed dummy
scoreboard objectives add DekuFlowerFloatEnd dummy
scoreboard objectives add DekuFlowerDescentDistance dummy
scoreboard objectives add Sneak dummy
scoreboard objectives add _DekuFlowerTimer dummy
scoreboard objectives add UseItem dummy
scoreboard objectives add Cooldown dummy
scoreboard objectives add DekuWater dummy
scoreboard objectives add DekuBounceCount dummy
