...
execute unless entity @s[tag=Orchestrated] run scoreboard players set @s MusicEnd 10360

execute if entity @s[tag=Orchestrated] run playsound minecraft:shooting_gallery music @s ~ ~ ~ 10000000
execute if entity @s[tag=Orchestrated] run scoreboard players set @s MusicEnd 10360
