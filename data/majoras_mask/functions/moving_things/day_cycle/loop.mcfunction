...
# Music
execute if entity @s[scores={DayCycle=1,Time=12000},tag=!Indoors] run stopsound @a music
execute if entity @s[scores={DayCycle=2,Time=12000},tag=!Indoors] run stopsound @a music
execute if entity @s[scores={DayCycle=3,Time=12000},tag=!Indoors] run stopsound @a music
execute if entity @s[scores={DayCycle=3,Time=18000},tag=!Indoors] run function majoras_mask:music/clocktown_finalhours

execute if entity @s[scores={Time=0}] run tag @s add Morning
execute if entity @s[scores={Time=0},tag=Morning,tag=!Indoors] run stopsound @a music
execute if entity @s[scores={Time=1},tag=Morning,tag=!Indoors] run function majoras_mask:music/morning
execute if entity @s[scores={Time=159},tag=Morning,tag=Slow_Time,tag=!Indoors] run stopsound @a music
execute if entity @s[scores={Time=319},tag=Morning,tag=!Slow_Time,tag=!Indoors] run stopsound @a music
execute if entity @s[scores={DayCycle=1,Time=320},tag=Morning,tag=!Indoors] run function majoras_mask:music/clocktown_day1
execute if entity @s[scores={DayCycle=2,Time=320},tag=Morning,tag=!Indoors] run function majoras_mask:music/clocktown_day2
execute if entity @s[scores={DayCycle=3,Time=320},tag=Morning,tag=!Indoors] run function majoras_mask:music/clocktown_day3
