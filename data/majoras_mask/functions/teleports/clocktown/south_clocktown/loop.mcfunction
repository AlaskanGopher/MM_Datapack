...
execute if entity @s[x=296,y=54,z=-374,dx=0,dz=5] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/middle_east_clocktown
execute if entity @s[x=313,y=57,z=-348,dx=3,dz=0] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/north_clocktown
