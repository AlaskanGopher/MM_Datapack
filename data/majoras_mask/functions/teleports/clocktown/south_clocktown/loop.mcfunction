...
execute if entity @s[x=292,y=54,z=-374,dx=0,dy=5,dz=5] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/middle_east_clocktown
execute if entity @s[x=313,y=57,z=-340,dx=3,dy=5,dz=0] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/north_clocktown
execute if entity @s[x=334,y=49,z=-399,dx=0,dy=5,dz=4] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/south_west_clocktown
execute if entity @s[x=341,y=56,z=-367,dx=0,dy=13,dz=5] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/middle_west_clocktown
