...
# Tunnels
execute if entity @s[x=34,y=103,z=42,dx=0,dy=6,dz=-8] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/to_east_clocktown_southern
execute if entity @s[x=23,y=104,z=8,dx=0,dy=5,dz=-5] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/to_east_clocktown_central
...
execute if entity @s[x=-20,y=100,z=33,dx=0,dy=5,dz=-4] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/to_west_clocktown_southern
execute if entity @s[x=-32,y=107,z=1,dx=0,dy=11,dz=-5] run function majoras_mask:teleports/clocktown/south_clocktown/tunnels/to_west_clocktown_central
