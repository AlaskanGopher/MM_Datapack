...
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ as @e[type=wither_skeleton,tag=Gibdo,distance=..1.8] run tag @s add Stun
...
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=zombie,tag=Redead,distance=..2] run scoreboard players set @s Hookshot 199
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=zombie,tag=Gibdo,distance=..2] run scoreboard players set @s Hookshot 199
...
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=wither_skeleton,tag=Gibdo,distance=..1.8] run scoreboard players set @s Hookshot 199
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=wither_skeleton,tag=Redead,distance=..1.8] run scoreboard players set @s Hookshot 199
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=zombie,tag=IronKnuckle,distance=..1.8] run scoreboard players set @s Hookshot 199
execute if entity @s[scores={Hookshot=2..100}] positioned ~ ~.5 ~ unless entity @s[scores={Hookshot=200..}] if entity @e[type=zombie,tag=NabooruKnuckle,distance=..1.8] run scoreboard players set @s Hookshot 199
