...
execute if entity @s[scores={SpiritMagic=1}] as @e[type=wither_skeleton,tag=Redead,distance=..8] unless entity @s[nbt={Invulnerable:1b}] run effect give @s minecraft:instant_health 1 2 true
