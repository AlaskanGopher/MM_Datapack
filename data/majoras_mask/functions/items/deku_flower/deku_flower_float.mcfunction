...
# Stop
execute unless entity @s[tag=Float] unless entity @s[tag=DekuLaunch] if entity @s[tag=SlowFalling] unless block ~ ~-.6 ~ air run tag @s remove Float
execute unless entity @s[tag=Float] unless entity @s[tag=DekuLaunch] if entity @s[tag=SlowFalling] unless block ~ ~-.6 ~ air run tag @s remove SlowFalling
execute unless entity @s[tag=SlowFalling] if block ~ ~-.6 ~ air run effect clear @s slow_falling
execute unless entity @s[tag=SlowFalling] if block ~ ~-.6 ~ air run effect clear @s levitation
