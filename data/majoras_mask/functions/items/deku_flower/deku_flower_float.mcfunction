...
execute unless entity @s[tag=SlowFalling] unless block ~ ~-.6 ~ air run effect clear @s slow_falling
execute unless entity @s[tag=SlowFalling] unless block ~ ~-.6 ~ air run effect clear @s levitation
