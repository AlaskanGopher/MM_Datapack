...
#Sounds
execute if entity @s[scores={_DekuFlowerTimer=15..}] run playsound minecraft:entity.item_frame.rotate_item block @s ~ ~ ~ 0.5 1
execute if entity @s[scores={_DekuFlowerTimer=75}] run playsound minecraft:entity.ender_dragon.flap block @s ~ ~ ~ 0.5 1
execute if entity @s[scores={_DekuFlowerTimer=95}] run playsound minecraft:entity.ender_dragon.flap block @s ~ ~ ~ 0.5 1
execute if entity @s[scores={_DekuFlowerTimer=115}] run playsound minecraft:entity.ender_dragon.flap block @s ~ ~ ~ 0.5 1
execute if entity @s[scores={_DekuFlowerTimer=135}] run playsound minecraft:entity.ender_dragon.flap block @s ~ ~ ~ 0.5 1
execute if entity @s[scores={_DekuFlowerTimer=15..,Sneak=1..}] run playsound minecraft:entity.ender_dragon.flap block @s ~ ~ ~ 0.5 1
#
...
execute if entity @s[scores={_DekuFlowerTimer=15..}] at @s if block ~ ~-.6 ~ minecraft:air as @e[type=armor_stand,tag=FlowerFloat] at @s run tp @s ~ ~-0.07 ~
