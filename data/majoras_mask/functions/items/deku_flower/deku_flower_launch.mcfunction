...
execute as @a[tag=DekuLaunch] at @s run function majoras_mask:items/deku_flower/deku_flower_float
execute as @a[tag=Float] at @s run function majoras_mask:items/deku_flower/deku_flower_float
execute as @a[tag=SlowFalling] at @s run function majoras_mask:items/deku_flower/deku_flower_float