...
execute if entity @s[scores={UseItem=1..}] if entity @s[nbt={SelectedItem:{tag:{BottledPoe:1b}}}] run clear @s minecraft:carrot_on_a_stick{display:{Name:"{\"text\":\"Poe\"}"},Unbreakable:1b,Damage:4,HideFlags:63,BottledPoe:1b} 1
