...
execute if entity @s[tag=Fire] positioned ~ ~-1 ~ if block ~ ~ ~ minecraft:jungle_fence run fill ~ ~1 ~ ~ ~1 ~ minecraft:torch
execute if entity @s[tag=Fire] positioned ~ ~-2 ~ if block ~ ~ ~ minecraft:jungle_fence run fill ~ ~1 ~ ~ ~1 ~ minecraft:torch
