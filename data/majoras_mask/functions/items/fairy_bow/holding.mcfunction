...
execute unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[nbt={SelectedItem:{tag:{NormalArrow:1b}}}] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.mainhand with minecraft:bow{display:{Name:"{\"text\":\"Fairy Bow\"}"},Unbreakable:1b,FairyBow:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
execute if entity @s[tag=HoldingBow] unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[tag=NormalArrow] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.offhand with minecraft:arrow{display:{Name:"{\"text\":\"Arrow\"}"},NormalArrowFake:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
...
execute unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[level=1..,nbt={SelectedItem:{tag:{FireArrow:1b}}}] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.mainhand with minecraft:bow{display:{Name:"{\"text\":\"Fairy Bow\"}"},Unbreakable:1b,FairyBow:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
execute if entity @s[tag=HoldingBow] unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[tag=FireArrow] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.offhand with minecraft:tipped_arrow{Potion:"healing",display:{Name:"{\"text\":\"Fire Arrow\"}"},FireArrowFake:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
...
execute unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[level=1..,nbt={SelectedItem:{tag:{IceArrow:1b}}}] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.mainhand with minecraft:bow{display:{Name:"{\"text\":\"Fairy Bow\"}"},Unbreakable:1b,FairyBow:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
execute if entity @s[tag=HoldingBow] unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[tag=IceArrow] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.offhand with minecraft:tipped_arrow{Potion:"night_vision",display:{Name:"{\"text\":\"Fire Arrow\"}"},IceArrowFake:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
...
execute unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[level=2..,nbt={SelectedItem:{tag:{LightArrow:1b}}}] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.mainhand with minecraft:bow{display:{Name:"{\"text\":\"Fairy Bow\"}"},Unbreakable:1b,FairyBow:1b,HideFlags:63,ArrowBow:1b,MainHandItem:1b} 1
execute if entity @s[tag=HoldingBow] unless entity @s[tag=EmptyBow] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] if entity @s[tag=LightArrow] unless block ~ ~.5 ~ minecraft:water unless block ~ ~-.2 ~ minecraft:water run item replace entity @s weapon.offhand with minecraft:tipped_arrow{Potion:"slow_falling",display:{Name:"{\"text\":\"Light Arrow\"}"},LightArrowFake:1b,CustomModelData:1,HideFlags:63,ArrowBow:1b,MainHandItem:1b}
