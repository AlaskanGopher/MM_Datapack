...
execute if entity @s[scores={timer=100..}] as @e[type=zombie,tag=Leever,distance=..3] run effect give @s minecraft:instant_health 1 0 true
execute if entity @s[scores={timer=100..}] as @e[type=zombie,tag=Guay,distance=..3] run kill @s
execute if entity @s[scores={timer=100..}] as @e[type=zombie,tag=IronKnuckle,distance=..3] run effect give @s minecraft:instant_health 1 0 true
...
execute if entity @s[scores={timer=100..}] as @e[type=zombie,tag=Lizalfos,tag=!JumpAttack,distance=..3] run effect give @s minecraft:instant_health 1 0 true
execute if entity @s[scores={timer=100..}] as @e[type=zombie,tag=Dinolfos,tag=!JumpOver,distance=..3] run effect give @s minecraft:instant_health 1 0 true
