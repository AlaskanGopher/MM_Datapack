...
execute if entity @s[nbt={HurtTime:10s}] run tag @s add Cooldown
execute if entity @s[tag=Cooldown] run scoreboard players add @s ArrowCount 1
execute if entity @s[tag=Cooldown] run data merge entity @s {NoAI:1b}
execute if entity @s[scores={ArrowCount=20..}] run data merge entity @s {NoAI:0b}
execute if entity @s[scores={ArrowCount=20..}] run tag @s remove Cooldown
execute if entity @s[scores={ArrowCount=20..}] run scoreboard players set @s ArrowCount 0
