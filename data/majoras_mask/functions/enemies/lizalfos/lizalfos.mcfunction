...
execute unless entity @s[tag=Run] if entity @s[scores={timer=1}] unless entity @s[scores={text=0}] run scoreboard players operation @s text -= @s lifetime
...
execute if entity @s[scores={lifetime=8..}] run scoreboard players set @s lifetime 1
execute if entity @s[scores={lifetime=..0}] run scoreboard players set @s lifetime 7
...
execute if block 2269 37 1930 minecraft:air if entity @s[y=48,dy=1] run tp @s 2269 37 1925
execute if block 2269 37 1930 minecraft:air if entity @s[y=33,dy=1] run tp @s 2269 37 1925
