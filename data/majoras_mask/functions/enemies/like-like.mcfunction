...
#Clear
execute if entity @s[scores={lifetime=1}] if entity @a[nbt={Inventory:[{Slot:102b,id:"minecraft:leather_chestplate",Count:1b,tag:{GoronTunic:1b}}]}] run clear @a minecraft:leather_chestplate{display:{color:14942208,Name:"{\"text\":\"Goron Tunic\"}"},Unbreakable:1b,GoronTunic:1b,HideFlags:46} 1
execute if entity @s[scores={lifetime=1}] if entity @a[nbt={Inventory:[{Slot:102b,id:"minecraft:leather_chestplate",Count:1b,tag:{ZoraTunic:1b}}]}] run clear @a minecraft:leather_chestplate{display:{color:1521151,Name:"{\"text\":\"Zora Tunic\"}"},Unbreakable:1b,ZoraTunic:1b,HideFlags:46} 1
execute if entity @s[scores={lifetime=1}] if entity @a[nbt={SelectedItem:{id:"minecraft:shield",Count:1b}}] run clear @a minecraft:shield{Unbreakable:1b,Damage:2,display:{Name:"\"Hylian Shield\""}} 1
execute if entity @s[scores={lifetime=1}] if entity @a[nbt={Inventory:[{Slot:-106b,id:"minecraft:shield",Count:1b}]}] run clear @a minecraft:shield{Unbreakable:1b,Damage:2,display:{Name:"\"Hylian Shield\""}} 1
